...
import { ColorPicker } from './ColorPicker'; // Assuming you have this component or will create it
...
const HeaderPreview = styled.div<{ backgroundImage?: string; backgroundOpacity: number; backgroundColor: string; textColor: string }>`
  width: 100%;
  height: 120px;
...
const TemplateThumbnail = styled.div<{ bgColor: string; textColor: string }>`
  height: 60px;
            ...
            {localBackgroundImage && (
              <SliderContainer>
                ...
                <Slider
                  ...
                  onValueChange={(values) => setLocalBackgroundOpacity(values[0])}
                />
              </SliderContainer>
            )}
          </div>
          ...
          <SettingsGrid>
            ...
            <SettingCard>
              ...
              <Popover>
                ...
                <PopoverContent>
                  <div className="p-2">
                    <div className="mb-2 font-medium">Choose Accent Color</div>
                    <div className="grid grid-cols-5 gap-2 mb-2">
                      {['#0070f3', '#2e7d32', '#f5a623', '#d32f2f', '#8e44ad'].map(color => (
                        <ColorButton
                          key={color}
                          color={color}
                          active={localAccentColor === color}
