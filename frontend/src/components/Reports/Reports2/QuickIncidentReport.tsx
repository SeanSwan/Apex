...
const QuickIncidentReport: React.FC<QuickIncidentReportProps> = ({ 
  ...
  const [expiryHours, setExpiryHours] = useState(72); // Default 3 days
      ...
      <FormSection>
        ...
        <FormGrid>
          <InputContainer>
            ...
            >
              <Select.Trigger id="incident-type" className="w-full">
          ...
          <InputContainer>
            ...
            >
              <Select.Trigger id="severity" className="w-full">
                <Select.Value placeholder="Select severity level" />
              </Select.Trigger>
              <Select.Content>
                <Select.Group>
                  {SEVERITY_LEVELS.map(level => (
                    <Select.Item key={level.value} value={level.value}>{level.label}</Select.Item>
                  ))}
                </Select.Group>
              </Select.Content>
            </Select>
